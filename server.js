...
// TODO: Only show updated values of the type we want
// TODO: Send two sets: Updates + deletes
  wordCount.find({value: {$gt: 50}}).sort({value:'descending'}).limit(100).skip(1).exec(function (err, data) {
    if(err) {
